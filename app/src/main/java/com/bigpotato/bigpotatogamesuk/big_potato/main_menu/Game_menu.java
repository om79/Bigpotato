...
//        usefull = new UsefullData(getApplicationContext());
    ...
    public List<Data> fill_with_data() {
        ...
        data.add(new Data(R.mipmap.bod, 8));
        data.add(new Data(R.mipmap.mr_lister, 0));
        data.add(new Data(R.mipmap.scrawl, 1));
        data.add(new Data(R.mipmap.obamallama, 2));
        data.add(new Data(R.mipmap.okplay_background,3));
        data.add(new Data(R.mipmap.cham_back,4));

        data.add(new Data(R.mipmap.rainbow_rage,6));
        data.add(new Data(R.mipmap.qwordie,5));
