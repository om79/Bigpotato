 ...
 */
public class Cham_how_2 extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.cham_how_2, container, false);
        ...
        TextView v=(TextView)  rootView.findViewById(R.id.textcqqmr1);
        v.setTypeface(regular);

        TextView v1=(TextView)  rootView.findViewById(R.id.texpppmr1);
