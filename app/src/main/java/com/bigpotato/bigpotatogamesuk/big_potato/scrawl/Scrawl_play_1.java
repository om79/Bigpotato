 ...
 */
public class Scrawl_play_1 extends Fragment {

    Typeface regular, bold;


    public Scrawl_play_1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.scrawl_play_1, container, false);
        ...
        TextView v = (TextView) rootView.findViewById(R.id.textViewddddd3__2);
        v.setTypeface(regular);

        TextView v1=(TextView)  rootView.findViewById(R.id.textView5__2_fafasf);
