 ...
 */
public class Squirms_how_2 extends Fragment
{


    Typeface regular,bold;

    public Squirms_how_2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.squirms_how_2, container, false);
        ...
        TextView v=(TextView)  rootView.findViewById(R.id.textchn3__2_mr1s2);
        v.setTypeface(regular);

        TextView v1=(TextView)  rootView.findViewById(R.id.textVssav_2_mr1s2);
