package com.bigpotato.bigpotatogamesus.big_potato.hompage;
...
import com.bigpotato.bigpotatogamesus.big_potato.bucket_of_doom.Bod_homepage;
import com.bigpotato.bigpotatogamesus.big_potato.chameleon.Chameleon_activity;
import com.bigpotato.bigpotatogamesus.big_potato.mr_lister.Mr_homepage;
import com.bigpotato.bigpotatogamesus.big_potato.obla.Obla_homapage;
import com.bigpotato.bigpotatogamesus.big_potato.ok_play.Ok_play_homescreen;
import com.bigpotato.bigpotatogamesus.big_potato.scrawl.Scraml_homepage;
import com.bigpotato.bigpotatogamesus.big_potato.social.Social_activity;
import com.bigpotato.bigpotatogamesus.big_potato.squirms.Squirms_homescreen;
...
public class Home_page extends Activity {
    ...
    String[] cs = new String[] { "bod", "mr_lister", "scrwal",
            "obama","squirms","ok_play","cham" };
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    SaveData save;
    int pos=0;
    int[] c = new int[] { R.mipmap.bottom_bod,R.mipmap.bottom_mr_lister, R.mipmap.bottom_scrawl,
            R.mipmap.bottom_obamallama,R.mipmap.bottom_squirms,R.mipmap.bottom_bar_okplay,R.mipmap.bottom_cham_back};
        ...
        switch (save.getString("current_game"))
        {
            ...
            case "SQUIRMS":
                if (savedInstanceState == null) {
                    FragmentManager fragmentManager = getFragmentManager();
                    fragmentManager.beginTransaction()
                            .replace(R.id.frame_container, new Squirms_homescreen()).commit();
                }
                mAdapter = new RolodexViewAdapter(c,cs,getApplicationContext(),"squirms");
                mRecyclerView.setAdapter(mAdapter);
