 ...
 */
public class Cham_how_1 extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.cham_how_1, container, false);
        ...
        TextView v=(TextView)  rootView.findViewById(R.id.textchn3__2_mr1);
        v.setTypeface(regular);

        TextView v1=(TextView)  rootView.findViewById(R.id.textVssav_2_mr1);
