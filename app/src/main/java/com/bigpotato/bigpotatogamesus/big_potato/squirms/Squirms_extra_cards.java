...
import com.bigpotato.bigpotatogamesus.big_potato.chameleon.Cham_cards;
 ...
 */
public class Squirms_extra_cards extends Activity
{
    GridView gv;
    ImageView back;
    ...
    int[] qpic=new int[]{R.mipmap.squirm_1,R.mipmap.squirm_2,R.mipmap.squirm_3,R.mipmap.squirm_4,R.mipmap.squirm_7,R.mipmap.squirm_5,
           R.mipmap.squirm_6,R.mipmap.squirm_8,R.mipmap.squirm_9,R.mipmap.squirm_10,R.mipmap.squirm_11,R.mipmap.squirm_12};
    ImageView header;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save_data=new SaveData(Squirms_extra_cards.this);
...
//        layoutParams.bottomMargin = 45;
        ...
        rel.setBackground(getResources().getDrawable(R.mipmap.squirms_how));
        ...
        header.setImageResource(R.mipmap.squirms_extra_head);
        ...
        gv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                save_data.save("Squirms"+position,position);
                Intent b= new Intent(Squirms_extra_cards.this,Squirms_cards.class);
...
//            overridePendingTransition(R.anim.trans_right_in, R.anim.trans_right_out);
    ...
    class set_images extends AsyncTask<Void, Void, Void> {
        ...
        {
            actorsList.clear();
            dialog = new ProgressDialog(Squirms_extra_cards.this, AlertDialog.THEME_HOLO_DARK);
      ...
      protected Void doInBackground(Void... arg0) {
            for (int i = 0; i < 12; i++) {
                ...
                if(save_data.isExist("Squirms"+i)==true)
                {
                    actor.setimage(qpic[i]);
                    actor.settitle("");

                }else {
                    actor.setimage(R.mipmap.squirm_show);
                    actor.settitle("");
                }
