...
public class Mr_homepage extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        extra=(TextView) rootView.findViewById(R.id.exta_cards_bod_mr);
        extra.setOnClickListener(this);
        scenario=(TextView) rootView.findViewById(R.id.exta_cards_scen_bod_mr);
        scenario.setOnClickListener(this);
        how=(TextView) rootView.findViewById(R.id.how_to_play_bod_mr);
        how.setOnClickListener(this);
        buy=(TextView) rootView.findViewById(R.id.buy_the_game_bod_mr);
        buy.setOnClickListener(this);
        back = (ImageButton) rootView.findViewById(R.id.back_bod_mr);
        ...
        tag=(TextView) rootView.findViewById(R.id.hashtag2);
    ...
    public void onClick(View view)
    {
        ...
        switch (view.getId())
        {
            ...
            case R.id.exta_cards_bod_mr:
                ...
                Intent extra=new Intent(getActivity(),Mr_extra_cards.class);
                startActivity(extra);
            ...
            case R.id.exta_cards_scen_bod_mr:
                ...
                Intent s=new Intent(getActivity(),Mr_sound_effect.class);
                startActivity(s);
                getActivity().overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
