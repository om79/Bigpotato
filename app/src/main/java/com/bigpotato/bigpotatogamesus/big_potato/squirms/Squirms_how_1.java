 ...
 */
public class Squirms_how_1 extends Fragment
{


    Typeface regular,bold;

    public Squirms_how_1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.squirms_how_1, container, false);
        ...
        TextView v1=(TextView)  rootView.findViewById(R.id.textVssav_2_mr1s);
